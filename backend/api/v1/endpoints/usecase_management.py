...
# Removed _get_user_from_token - now using get_current_user from deps.py
...
def list_usecases(
    ...
    return list_usecases_simple(db=db, user=user)
...
# Removed duplicated update_usecase_model_frontend endpoint
